...
$options = array (
	...
	array( "id" => "d_avatarDate","type" => "number","std" => "15","txt" => "缓存天数："),
...
<div class="wrap d_wrap">
	...
	<h2><?php echo $themename; ?>设置
		<span class="d_themedesc">作者：<a href="http://www.54ux.com/" target="_blank">wordpress教程网</a> &nbsp;&nbsp; <a href="http://www.54ux.com/" target="_blank"><?php echo $themename; ?>更新说明及问题提交</a></span>
	</h2>
