	...
	<div id="respond">
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" name="commentform">
			...
			<div class="input-prepend">
			  ...
			  <input class="span2"  name="author" id="author" value="<?php echo $comment_author; ?>"  type="text" placeholder="昵称">
			</div><br />
			<div class="input-prepend">
			  <span class="add-on">邮箱</span>
			  <input class="span2"  name="email" id="email" value="<?php echo $comment_author_email; ?>"  type="text" placeholder="邮箱">
			</div><br />
			<div class="input-prepend">
			  <span class="add-on">网址</span>
			  <input class="span2"  name="url" id="url" value="<?php echo $comment_author_url; ?>" type="text" placeholder="昵称">
			</div>
